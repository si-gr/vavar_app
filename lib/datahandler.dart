...
// usually instantly returns
  ...
  void processUpdate(int blePacketNum) {
    ...
    if (blePacketNum == 1 || blePacketNum == 10) {
      // new wind
  ...
  void parse_ble_data(List<int> data) {
    ...
    switch (blePacketNum) {
      ...
      case 10:  // fast variant 1
        ...
        roll = byteData.getInt16(10, Endian.little) / 0x8000 * pi;
        pitch = byteData.getInt16(12, Endian.little) / 0x8000 * pi;
        yaw = byteData.getInt16(14, Endian.little) / 0x8000 * pi;
        writeData(
